"""
data_setup.py - download Oxford-IIIT Pet, keep only our 5 dog breeds, and hand
back ready-to-train DataLoaders. This is the plumbing; the modeling lives in the
classifier you'll write.
...
# The 5 dog breeds we'll classify (these exact names exist in Oxford-IIIT Pet).
BREEDS = ["Beagle", "Boxer", "Pug", "Samoyed", "Shiba Inu"]
...
class _DogBreeds(Dataset):
    """Oxford-IIIT Pet filtered to our breeds, with labels remapped to 0..4.
    ...
    def __getitem__(self, i):
        ...
        return image, self.remap[label]  # we hand back 0..4
